...
parse.add_argument('--image_size', type=int, default=136)
parse.add_argument('--label_size', type=int, default=136)
...
parse.add_argument('--stride', type=int, default=200)
...
srcnn = FusionGAN(image_size=136, label_size=136, batch_size=4,  c_dim=1,
