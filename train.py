# -*- coding: utf-8 -*-
from model import CGAN, netD, netG
import argparse
import os
...
parse.add_argument('--label_size', type=int, default=120)
parse.add_argument('--learning_rate', type=float, default=1e-4)  # or 2e-4
